  ...
  return (
    ...
    >
      ...
      {showLeft && (
        <button
          onClick={() => scroll("left")}
          className="absolute left-0 top-1/2 z-10 bg-white shadow-lg hover:bg-orange-100 rounded-full w-10 h-10 flex items-center justify-center transition-all"
        >
          ...
          return (
            ...
            >
              <div className="flex flex-col items-center justify-center p-5">
                <Icon className="w-10 h-10 text-orange-700 mb-3" />
                <p>{category.name}</p>
              </div>
            </motion.div>
          );
      ...
      {showRight && (
        <button
          ...
          className="absolute right-0 top-1/2 z-10 bg-white shadow-lg hover:bg-orange-100 rounded-full w-10 h-10 flex items-center justify-center transition-all"
        >
